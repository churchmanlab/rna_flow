...
# Python v3.7.4
# 
# Source: `Timescale_Bayes_20221117_rev1p1.ipynb` and `Timescale_Bayes_20231201_prerun.py`  
# For RNA flow Bayesian rate estimation: generate a log_iii file with specs for a run iii for genes that have TIMEOUT in run ii 
...
def main():
    ...
    logger = logging.getLogger('Bayes_iii_prerun')
    log_file = os.path.join(outpath[o],'LogErr', 'Bayes20240119_iib_prerun.log')
    ...
    filename = 'Bayes20240119_' + org_map[o] + '_iia.log'
    ...
    for idx in log_iii.index:
        ...
        if _len < n_todo_rerun:#need for single rerun 
    ...
    filename = 'Bayes20240119_' + org_map[o] + '_iib.log'
