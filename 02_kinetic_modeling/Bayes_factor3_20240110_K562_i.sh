...
baseDir=/n/groups/churchman/ri23/bseq/BayesFactor3_${date}_K562 #K562 for human, 3T3 for mouse
N_BATCH=726 #floor((wc -l genes_w_rates.csv) / batch_size in Timescale_Bayes_${date}.py script)
...
echo "end of Bayes_factor3_20240110_K562_i.sh"
