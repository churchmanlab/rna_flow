...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Merge Bayes Factor 3 compartment method output from batches into single file.')
    ...
    logger = logging.getLogger('BayesFactor3_merge')
    log_file = os.path.join(outpath[o],'LogErr', 'BayesFactor3_20240110_merge.log')
