...
# This script is used for batch scripts used to run for all genes together with `Bayes_Factor4_20231213_*.sh`.   
...
def main():
    ...
    outpath = dict()
    outpath['h'] = os.path.join('/n','groups','churchman','ri23','bseq','BayesFactor4_20231213_K562') #temp: _oflow1
