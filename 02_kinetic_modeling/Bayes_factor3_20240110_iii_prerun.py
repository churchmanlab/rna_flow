...
def main():
    ...
    outpath = dict()
    outpath['h'] = os.path.join('/n','groups','churchman','ri23','bseq','BayesFactor3_20240110_K562')
    ...
    logger = logging.getLogger('BayesFactor3_iii_prerun')
    log_file = os.path.join(outpath[o],'LogErr', 'BayesFactor3_20240110_iii_prerun.log')
    ...
    filename = 'BayesFactor20240110_' + org_map[o] + '_ii.log'
    ...
    for idx in log_ii.index:
        ...
        filename = 'Bayes_factor_20240110_'+org_map[o]+'_batch'+str(i)+'.tsv'
    ...
    filename = 'BayesFactor20240110_' + org_map[o] + '_iii.log'
