...
# This script is used for batch scripts used to run for all genes together with `Timescale_Bayes_20240119_[K562|3T3]_[>=ii].sh`.   
...
def main():
    ...
    log_file = os.path.join(outpath[o],'LogErr', 'Bayes20240119_rates_%s_batch%s_py.log' % 
...
#     filename = 'Bayes_Rates_20240119_'+org_map[o]+'_batch'+str(args.start_id)+'.tsv' #run i
    filename = 'Bayes_Rates_20240119_'+org_map[o]+'_batch'+str(args.suffix_id)+'.tsv' #run >= ii
