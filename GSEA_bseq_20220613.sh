...
Timescales="chr nuc nucexp_from_chr nucdeg cyto poly_entry whole_cell"
...
do
    ...
    do
        ...
        do
            ...
            $program GSEAPreranked -gmx ftp.broadinstitute.org://pub/gsea/gene_sets/${gs}.v7.5.1.symbols.gmt \
